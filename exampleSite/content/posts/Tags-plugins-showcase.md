...
The gist shortcode was deprecated in Hugo v0.143.0. For modern Hugo sites, consider using:

- Direct GitHub Gist embeds: `<script src="https://gist.github.com/imathis/996818.js"></script>`
- Code blocks with syntax highlighting
- External code hosting services

<p></p>

```javascript
// Example code block instead of gist
function example() {
  console.log("This replaces the deprecated gist shortcode");
  return "Modern Hugo approach";
}
```
